...
function Search() {
    ...
    return  (
            <div className="position-relative">
                ...
                <input type="text" onChange={handleChange} className="input_search" placeholder="search"/>
                                    ...
                                    <ul>
                                    {
                                        movies.map(movie => (
                                            <li className="border-bottom border-secondary" key={movie.id}>
                                                <Link to={`/${movie.id}`} className="d-flex align-items-center item text-white px-3 py-2 font-weight-bold">
                                                {
                                                    movie.poster_path ? (
