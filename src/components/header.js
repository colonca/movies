            ...
            <Navbar variant="dark" expand="lg" className="nav_header">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            <Nav.Link href="#home" style={{color:'white'}}>Movies</Nav.Link>
                            <Nav.Link href="#link" style={{color:'white'}}>TV Shows</Nav.Link>
                            <Nav.Link href="#link" style={{color:'white'}}>Actors</Nav.Link>
                        </Nav>
